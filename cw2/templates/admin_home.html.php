    ...
    <div class="row">
        <nav class="col-md-2 d-none d-md-block sidebar">
            <div class="sidebar-sticky">
                <h4 class="text-center text-white">Admin School System</h4>
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="category_manage.php">Adjust Categories</a>
                    </li>
                    <li class="nav-item">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <div class="all">
                <h1>All Users <br>
                    <span><?= htmlspecialchars(string: $allUsersCount) ?></span>
                </h1>
            </div>
            ...
            <div>
                <div class="stu">
                    <h1>All Students <br>
                        <span><?= htmlspecialchars($studentsCount) ?></span>
                    </h1>
                </div>

                <div class="teach">
                    <h1>All Teachers <br>
                        <span><?= htmlspecialchars($teachersCount) ?></span>
                    </h1>
                </div>
            </div>
        </main>
